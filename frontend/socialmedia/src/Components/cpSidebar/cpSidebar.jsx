...
export default function CpSidebar() {
    return (
        <nav id="sidebar">
            ...
            <ul id="sidebar-items">
                <li className="sidebar-item"><a href="" className="sidebar-item-link">Página Inicial</a></li>
                ...
                <li className="sidebar-item"><a href="" className="sidebar-item-link">Criar</a></li>
